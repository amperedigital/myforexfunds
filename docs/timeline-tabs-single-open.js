/**
 * Timeline tabs helper (mirrors the working logic from mff-story)
 * Keeps only one card/panel open while leaving Webflow interactions in control.
 */
(function timelineTabsSingleCard(config = {}) {
